          ...
          <div className="relative group">
            {profileImage ? (
              <img
                src={profileImage}
                alt={profile?.name}
                className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl object-cover border-2 border-indigo-100 shadow-sm"
                onError={(e) => {
              ...
              <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 text-white font-bold text-3xl flex items-center justify-center shadow-sm">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="p-6 sm:p-8 border-b border-slate-100 bg-slate-50/50">
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Update your account display name and avatar. Email and security credentials cannot be changed here.
            </p>
          </div>
