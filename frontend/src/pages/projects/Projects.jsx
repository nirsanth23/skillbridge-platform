      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Manage and track project postings you have created
                </p>
              </div>
            </div>
          </div>
          ...
          {canCreate ? (
            <Link
              to="/projects/create"
              className="inline-flex items-center justify-center space-x-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-semibold shadow-sm transition"
            >
              <Plus className="w-4 h-4" />
              <span>Create Project</span>
            </Link>
          ) : (
            <div className="text-xs text-slate-500 bg-slate-100 px-3 py-2 rounded-xl border border-slate-200">
              Project creation is enabled for Students, Clients, and Companies.
            </div>
          )}
        </div>
